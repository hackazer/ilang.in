            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="icon" id="icon" value="<?php echo old('icon') ?>" placeholder="e.g. fa-solid fa-plus" autocomplete="off" aria-describedby="plan-icon-help">
