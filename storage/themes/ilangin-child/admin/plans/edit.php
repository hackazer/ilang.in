...
<div class="card">
    <div class="card-body">
        <form method="post" action="<?php echo route('admin.plans.update', [$plan->id]) ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="icon" id="icon" value="<?php echo $plan->icon ?>" placeholder="e.g. fa-solid fa-plus" autocomplete="off" aria-describedby="plan-icon-help">
                        <p class="form-text" id="plan-icon-help"><?php ee('Choose a Font Awesome icon or enter its classes, for example fa-solid fa-plus.') ?></p>
                    </div>                
                </div>
            </div>                        	
            <hr>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="mb-4  <?php echo $plan->free ? 'd-none': '' ?>">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <div class="mb-4  <?php echo !$plan->permission->team->enabled ? 'd-none': '' ?>">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4 <?php echo !$plan->permission->splash->enabled ? 'd-none': '' ?>">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4  <?php echo !$plan->permission->overlay->enabled ? 'd-none': '' ?>">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <div class="mb-4  <?php echo !$plan->permission->pixels->enabled ? 'd-none': '' ?>">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4  <?php echo !$plan->permission->domain->enabled ? 'd-none': '' ?>">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4 <?php echo !$plan->permission->qr->enabled ? 'd-none': '' ?>">
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    ...
                    <div class="mb-4 <?php echo !$plan->permission->bio->enabled ? 'd-none': '' ?>">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4 <?php echo !isset($plan->permission->channels->enabled) || !$plan->permission->channels->enabled ? 'd-none': '' ?>">
            ...
            <?php if($features = plug('feature')): ?>
                <?php foreach($features as $feature): ?>
                    ...
                    <?php if($feature['count']): ?>
                        <div class="mb-4 <?php echo isset($plan->permission->{$feature['slug']}->enabled) && $plan->permission->{$feature['slug']}->enabled ? '': 'd-none' ?>">
