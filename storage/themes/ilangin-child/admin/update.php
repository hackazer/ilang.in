...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-header"><?php ee('Custom Information') ?></div>            
            <div class="card-body">
                <p>Built with Love by KSATRIA.</p>
                 <span class="text-success mb-2 d-block">Visit <i data-feather="mail"></i> <a href="https://ksatriacorp.com/" target="_blank" class="text-success">KSATRIA</a></span>
            </div>
        </div>
    </div>  
</div>
