        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="<?php echo route('admin.settings.save') ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-3  <?php if(!config('fb_connect')) echo 'd-none' ?>">
                    ...
                    <div class="mb-3 <?php if(!config('tw_connect')) echo 'd-none' ?>">
                    ...
                    <div class="mb-3 <?php if(!config('gl_connect')) echo 'd-none' ?>">
