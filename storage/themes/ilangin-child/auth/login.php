<section>
                    ...
                    <div class="col-11 col-lg-10 col-xl-6">
                        <div class="mt-5">
                            ...
                            <form method="post" action="<?php echo route('login.auth') ?>">                                
                                <div class="mb-3">
                                    <label class="form-label"><?php ee('Email or username') ?></label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" class="form-control" id="input-email" name="email" placeholder="">
                                    </div>
                                ...
                                <div class="my-4">
                                    <div class="form-check mb-3">
                                        ...
                                        <label class="form-check-label" for="rememberme"><strong><?php ee('Remember me') ?></strong></label>
                                    </div>
                                </div>                                
                                <div class="mt-4">
                                    <?php echo \Helpers\Captcha::display() ?>
                                    <?php echo csrf() ?>
                                    <button type="submit" class="btn w-100 btn-primary"><?php ee('Login') ?></button>
                                </div>
                            </form>
                                    ...
                                    <div class="row">
                                        <?php if(config('fb_connect')): ?>
                                            <div class="col-sm-12 mb-2">
                                                <a href="<?php echo route('login.facebook') ?>" class="btn w-100 btn-neutral btn-icon mb-3 mb-sm-0">
                                        ...
                                        <?php if(config('gl_connect')): ?>
                                            <div class="col-sm-12 mb-2">
                                                <a href="<?php echo route('login.google') ?>" class="btn w-100 btn-neutral btn-icon mb-3 mb-sm-0">
                                        ...
                                        <?php if(config('tw_connect')): ?>
                                            <div class="col-sm-12 mb-2">
                                                <a href="<?php echo route('login.twitter') ?>" class="btn w-100 btn-neutral btn-icon mb-3 mb-sm-0">
    ...
    <div <?php echo themeSettings::config('homecolor') ?> class="bg-dark position-absolute h-100 top-0 right-0 zindex-10 col-lg-6 col-xl-6 d-none d-lg-flex flex-column justify-content-center" data-bg-size="cover" data-bg-position="center">
