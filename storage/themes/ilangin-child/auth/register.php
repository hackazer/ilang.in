            ...
            <div class="col-md-8 col-lg-5 pt-6">
                <div>
                    ...
                    <form method="post" action="<?php echo route('register.validate')?>">
                        <div class="mb-3">
                            <label class="form-label" for="user-name"><?php ee('Username') ?></label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="user"></i></span>
                                <input type="text" class="form-control" id="user-name" name="username" placeholder="<?php ee('Please enter a username') ?>" value="<?php echo old('username') ?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="user-email"><?php ee('Email address') ?></label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="at-sign"></i></span>
                                <input type="email" class="form-control" id="user-email" name="email" placeholder="<?php ee('Please enter a valid email.') ?>" value="<?php echo old('email') ?>">
                            </div>
                        </div>
                        <div class="mb-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <label class="form-label" for="user-pass"><?php ee('Password') ?></label>
                                </div>                                
                            </div>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="key"></i></span>
                                <input type="password" class="form-control" id="user-pass" name="password" placeholder="<?php ee('Please enter a valid password.') ?>">
                            </div>
                        </div>
                        <div class="mb-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <label class="form-label" for="confirm-pass"><?php ee('Confirm Password') ?></label>
                                </div>
                            </div>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i data-feather="key"></i></span>
                                <input type="password" class="form-control" id="confirm-pass" name="cpassword" placeholder="<?php ee('Please confirm your password.') ?>">
                            </div>
                        </div>
                        <?php if($page): ?>
                            <div class="my-4">
                        ...
                        <div class="mt-4">
                            ...
                            <?php echo csrf() ?>
                            <button type="submit" class="btn w-100 btn-primary"><?php ee('Register') ?></button>
                        </div>
                    </form>
                    <div class="mt-4 text-center"><small><?php ee('Already have an account?') ?></small>
                        <a href="<?php echo route('login') ?>" class="small fw-bold"><?php ee('Login') ?></a>
                    </div>
