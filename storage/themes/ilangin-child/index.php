...
<!--     <section class="slice slice-lg bg-section-secondary">    
    ...
    <section class="slice">
        <div class="container">
            <div class="section-process-step mx-lg-n5 mt-sm-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-6 mb-5 mb-lg-0">
                            <div class="text-center">
                                ...
                                <div class="h1 text-primary">
                                    <span class="counter"><?php echo $count->links+2004512 ?></span>
                        ...
                        <div class="col-lg-4 col-6 mb-5 mb-lg-0">
                            <div class="text-center">
                                ...
                                <div class="h1 text-primary">
                                    <span class="counter"><?php echo $count->clicks+2924917 ?></span>
                                    <span class="counter-extra">+</span>
                                </div>
                        ...
                        <div class="col-lg-4 col-6 mb-5 mb-lg-0">
                            <div class="text-center">
                                ...
                                <div class="h1 text-primary">
                                    <span class="counter"><?php echo $count->users+709 ?></span>
                                    <span class="counter-extra">+</span>
                                </div>
