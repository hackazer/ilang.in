                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><form action="<?php echo route('admin.faq.delete', [$faq->id, \Core\Helper::nonce('faq.delete')]) ?>" method="post" class="m-0"><?php echo csrf() ?><button type="submit" class="dropdown-item"><i data-feather="trash"></i> <?php ee('Delete') ?></button></form></li>
                            </ul>
                        </td>
                    </tr>
                <?php endforeach ?>
