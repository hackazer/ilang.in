            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-4" id="language">
                            ...
                            <p class="form-text">
                                <?php echo e('If you have different pages for different languagesthen it is possible to redirect users to that page using the same short URL. Simply choose the language and enter the URL.')?>
                            </p>
