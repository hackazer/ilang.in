            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="icon" id="icon" value="<?php echo $plan->icon ?>" placeholder="fa-solid fa-plus" autocomplete="off" aria-describedby="icon-help">
                        <p class="form-text" id="icon-help"><?php ee('Choose a Font Awesome icon or enter a Font Awesome 7 class such as fa-solid fa-plus.') ?></p>
                    </div>
                </div>
            </div>
            <hr>
