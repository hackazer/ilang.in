...
<?php if($starred): ?>
<h5 class="h4 mb-5"><i data-feather="star"></i> <span class="align-middle ms-2"><?php ee('Starred Channels') ?></span></h5>
<div class="row">
        ...
        <div class="col-sm-6 col-md-4 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <p><i data-feather="menu" class="me-2"></i> <?php echo $channel->count ?> <?php ee('items') ?></p>
...
<h5 class="h4 mb-5"><i data-feather="package"></i> <span class="align-middle ms-2"><?php ee('My Channels') ?></span></h5>
<div class="row">
