        ...
        <div class="col-md-8" id="generator">
            ...
            <div class="card collapse" data-bs-parent="#generator" id="social">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control p-2" name="social[line]" placeholder="https://" data-error="<?php ee('Please enter a valid link') ?>">
                    </div>
                </div>
            </div>
            <div class="card collapse" data-bs-parent="#generator" id="appearance">
				...
				<div class="card-body">
                    ...
                    <div class="mb-3 mt-3">
                        <div class="btn-group">
                            <a href="#singlecolor" class="btn btn-primary btn-sm text-white" data-bs-toggle="collapse"><?php ee('Single Color') ?></a>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3 mt-3">
                            ...
                            <p><input type="text" class="form-control p-2" name="color" data-trigger="color" data-default="#ffffff" value="#ffffff"></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3 mt-3">
                            <label class="form-label"><?php ee('Background') ?></label>
                            <p><input type="text" class="form-control p-2" name="bg" data-trigger="color" value="#0000000"></p>
                        </div>
                    </div>
                </div>
