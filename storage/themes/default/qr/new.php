        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush list-group-dynamic">
                    <a class="list-group-item list-group-item-action active" data-bs-toggle="collapse" href="#text"><i class="me-2" data-feather="type"></i> <?php ee('Text') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#sms"><i class="me-2" data-feather="smartphone"></i><?php ee('SMS & Message') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#wifi"><i class="me-2" data-feather="wifi"></i> <?php ee('WiFi') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#staticvcard"><i class="me-2" data-feather="user"></i> <?php ee('Static vCard') ?></a>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                ...
                <div class="list-group list-group-flush list-group-dynamic">
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#vcard"><i class="me-2" data-feather="user"></i> <?php ee('vCard') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#link"><i class="me-2" data-feather="link"></i> <?php ee('Link') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#email"><i class="me-2" data-feather="mail"></i> <?php ee('Email') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#phone"><i class="me-2" data-feather="phone"></i> <?php ee('Phone') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#smsonly"><i class="me-2" data-feather="smartphone"></i><?php ee('SMS') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#file"><i class="me-2 fa fa-file fa-lg"></i> <?php ee('File') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#whatsapp"><i class="me-2 fab fa-whatsapp fa-lg"></i> <?php ee('Whatsapp') ?></a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="collapse" href="#crypto"><i class="me-2 fab fa-bitcoin fa-lg"></i> <?php ee('Cryptocurrency') ?></a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card card-body">
                ...
                <div class="mb-3 input-select mt-4">
            ...
            <div class="card" id="qrbuilder">
                <div class="collapse show" data-bs-parent="#qrbuilder" id="text">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="link">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="email">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="phone">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="sms">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="smsonly">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="file">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="whatsapp">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="vcard">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="staticvcard">
                    <div class="card-header">
                        <h5 class="card-title fw-bold"><i class="me-2" data-feather="user"></i> <?php ee('vCard') ?></h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="wifi">
                    <div class="card-header">
                ...
                <div class="collapse" data-bs-parent="#qrbuilder" id="crypto">
                    <div class="card-header">
            ...
            <div class="card">
				...
				<div class="card-body collapse" id="colors">
                    ...
                    <div class="mb-3">
                        <div class="btn-group">
                            <a href="#singlecolor" class="btn btn-primary btn-sm active" data-bs-toggle="collapse" data-trigger="color"><?php ee('Single Color') ?></a>
                            <a href="#gradient" class="btn btn-primary btn-sm" data-bs-toggle="collapse" data-trigger="color"><?php ee('Gradient Color') ?></a>
                        </div>
                    </div>
                    <?php endif ?>
                    <div id="singlecolor" class="collapse show" data-bs-parent="#colors">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    <?php if(\Helpers\QR::hasImagick()): ?>
                        <div id="gradient" class="collapse" data-bs-parent="#colors">
                    ...
                    <?php if(\Helpers\QR::hasImagick()): ?>
                        <div class="mb-3">
                            ...
                            <div class="btn-group mt-2 border rounded" role="group" aria-label="<?php echo e('Matrix Style') ?>">
                                <input type="radio" name="matrix" id="matrix-square" value="square" class="btn-check" autocomplete="off" checked>
                                ...
                                <input type="radio" name="matrix" id="matrix-circle" value="circle" class="btn-check" autocomplete="off">
                                ...
                                <input type="radio" name="matrix" id="matrix-dot" value="dot" class="btn-check" autocomplete="off">
                        ...
                        <div class="mb-3">
                            <span class="form-label d-block"><?php ee("Eye Style") ?></span>
                            <div class="btn-group mt-2 border rounded" role="group" aria-label="<?php echo e('Eye Style') ?>">
                                <input type="radio" name="eye" id="eye-square" value="square" class="btn-check" autocomplete="off" checked>
                                <label class="btn d-block text-center border rounded p-3 px-2 h-100" for="eye-square">
                                    <i class="mb-3" data-feather="square"></i><br><?php ee('Square') ?>
                                </label>
                                <input type="radio" name="eye" id="eye-circle" value="circle" class="btn-check" autocomplete="off">
