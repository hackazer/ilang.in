    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="card">
				...
				<div class="card-body collapse" id="colors">
                    ...
                    <div class="mb-3">
                        <div class="btn-group">
                            <a href="#singlecolor" class="btn btn-primary btn-sm" data-bs-toggle="collapse" data-trigger="color"><?php ee('Single Color') ?></a>
                            <a href="#gradient" class="btn btn-primary btn-sm" data-bs-toggle="collapse" data-trigger="color"><?php ee('Gradient Color') ?></a>
                        </div>
                    </div>
                    <?php endif ?>
                    <div id="singlecolor" class="collapse <?php echo isset($qr->data->color) ? 'show' : '' ?>" data-bs-parent="#colors">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    <?php if(\Helpers\QR::hasImagick()): ?>
                        <div id="gradient" class="collapse <?php echo isset($qr->data->gradient) ? 'show' : '' ?>" data-bs-parent="#colors">
                    ...
                    <?php if(\Helpers\QR::hasImagick()): ?>
                        <div class="mb-3">
                            ...
                            <div class="btn-group mt-2 border rounded" role="group" aria-label="<?php echo e('Matrix Style') ?>">
                                <input type="radio" name="matrix" id="matrix-square" value="square" class="btn-check" autocomplete="off" <?php echo isset($qr->data->matrix) && $qr->data->matrix == 'square' ? 'checked' : '' ?>>
                                ...
                                <input type="radio" name="matrix" id="matrix-circle" value="circle" class="btn-check" autocomplete="off" <?php echo isset($qr->data->matrix) && $qr->data->matrix == 'circle' ? 'checked' : '' ?>>
                                ...
                                <input type="radio" name="matrix" id="matrix-dot" value="dot" class="btn-check" autocomplete="off" <?php echo isset($qr->data->matrix) && $qr->data->matrix == 'dot' ? 'checked' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group mt-2 border rounded" role="group" aria-label="<?php echo e('Eye Style') ?>">
                                <input type="radio" name="eye" id="eye-square" value="square" class="btn-check" autocomplete="off" <?php echo isset($qr->data->eye) && $qr->data->eye == 'square' ? 'checked' : '' ?>>
                                <label class="btn d-block text-center border rounded p-3 px-2 h-100" for="eye-square">
                                    <i class="mb-3" data-feather="square"></i><br><?php ee('Square') ?>
                                </label>
                                <input type="radio" name="eye" id="eye-circle" value="circle" class="btn-check" autocomplete="off" <?php echo isset($qr->data->eye) && $qr->data->eye == 'circle' ? 'checked' : '' ?>>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="return-ajax">
                        <img src="<?php echo route('qr.generate', [$qr->alias]) ?>" class="img-fluid w-100 mw-50">
                    </div>
