            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="list-group list-group-flush">
                    ...
                    <?php foreach($menu as $id => $el): ?>
                        <h6 class="px-3 pt-3"><i data-feather="plus-circle" class="me-1"></i> <a href="#<?php echo $id ?>" data-bs-target="#holder-<?php echo $id ?>" data-bs-toggle="collapse"><?php echo $el['title'] ?></a> <?php echo ($el['admin']) ? '<small class="badge bg-warning text-dark text-xs float-end">'.e('Admin').'</small>' : '' ?></h6>
                    ...
                    <?php foreach($el['endpoints'] as $key => $data): ?>
                        <div id="<?php echo $id.'-'.$key ?>" class="row mb-5">
                            <div class="col-lg-7">
                                ...
                                <div class="card-body">
                                    <span class="badge badge-<?php echo \Helpers\App::apiMethodColor($data['method']) ?> me-2 align-middle text-xs"><?php echo $data['method'] ?></span> <code><?php echo $data['route'] ?></code>
