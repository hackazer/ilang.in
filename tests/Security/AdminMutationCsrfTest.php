...
final class AdminMutationCsrfTest extends TestCase
{
    private const POST_ROUTES = [
        'admin.plans.delete' => "Gem::post('/plans/{id}/delete/{nonce}', 'Admin\\Plans@delete')",
        'admin.plans.sync' => "Gem::post('/plans/sync', 'Admin\\Plans@sync')",
        'admin.plans.toggle' => "Gem::post('/plans/{id}/toggle', 'Admin\\Plans@toggle')",
        'admin.payments.delete' => "Gem::post('/payments/{id}/delete/{nonce}','Admin\\Membership@delete')",
        'admin.payments.markas' => "Gem::post('/payments/{id}/{action}','Admin\\Membership@markAs')",
        'admin.coupons.delete' => "Gem::post('/coupons/{id}/delete/{nonce}', 'Admin\\Coupons@delete')",
        'admin.tax.delete' => "Gem::post('/tax/{id}/delete/{nonce}', 'Admin\\Tax@delete')",
        'admin.links.delete' => "Gem::post('/links/{id}/delete/{nonce}', 'Admin\\Links@delete')",
        ...
        'admin.users.delete' => "Gem::post('/users/{id}/delete/{nonce}', 'Admin\\Users@delete')",
        'admin.users.delete.all' => "Gem::post('/users/{id}/wipe/{nonce}', 'Admin\\Users@wipe')",
        'admin.users.ban' => "Gem::post('/users/{id}/ban', 'Admin\\Users@ban')",
        'admin.users.verify' => "Gem::post('/user/verify/{id}/{token}', 'Admin\\Users@verify')",
        'admin.testimonial.delete' => "Gem::post('/users/testimonial/{id}/delete/{nonce}', 'Admin\\Users@testimonialDelete')",
        'admin.bio.delete' => "Gem::post('/bio/{id}/delete/{nonce}', 'Admin\\Bio@delete')",
        'admin.bio.toggle' => "Gem::post('/bio/toggle/{type}/{id}', 'Admin\\Bio@toggle')",
        'admin.qr.delete' => "Gem::post('/qr/{id}/delete/{nonce}', 'Admin\\Qr@delete')",
        'admin.page.delete' => "Gem::post('/page/{id}/delete/{nonce}', 'Admin\\Pages@delete')",
        'admin.blog.delete' => "Gem::post('/blog/{id}/delete/{nonce}', 'Admin\\Blog@delete')",
        'admin.domains.delete' => "Gem::post('/domains/{id}/delete/{nonce}', 'Admin\\Domains@delete')",
        ...
        'admin.faq.delete' => "Gem::post('/faq/{id}/delete/{nonce}', 'Admin\\Faqs@delete')",
        'admin.faq.categories.delete' => "Gem::post('/faq/categories/{id}/delete/{nonce}', 'Admin\\Faqs@categoriesDelete')",
        'admin.affiliate.delete' => "Gem::post('/affiliates/{id}/delete/{nonce}', 'Admin\\Affiliates@delete')",
        ...
        'admin.ads.delete' => "Gem::post('/ads/{id}/delete/{nonce}', 'Admin\\Ads@delete')",
        'admin.themes.delete' => "Gem::post('/themes/{id}/delete/{nonce}', 'Admin\\Themes@delete')",
        ...
        'admin.languages.delete' => "Gem::post('/languages/{id}/delete/{nonce}', 'Admin\\Languages@delete')",
